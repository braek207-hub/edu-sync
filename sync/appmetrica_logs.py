...
def app_country() -> str:
    """Страна, которой ограничены ПОКУПКИ в RU-витринах приложения.

    Витрина PROCONTEXT region='ru' режет по стране только покупки: проба 30072646 за
    31.08–06.09.2026 — наши 5 заказов против их 3, два лишних с устройства из DE; без них
    выручка сошлась ровно (38 195). Установки и сессии у него — все: с фильтром на них
    сессии VK 03–09.09.2026 просели до 12 800/день против его 14 226 (без фильтра 14 208),
    а установки откалиброваны по слайдам без фильтра. Решение Павла 13.09.2026 — как у
    PROCONTEXT. APP_COUNTRY="" выключает фильтр.
    """
