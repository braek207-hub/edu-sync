...
# Голую «куртка» не берём (поглотила бы остальные, двоила бы Σ). «парка» отдельным словом НЕ берём:
# Wordstat broad-match ловит «парк/парковка» (летний пик, ×10-100 масштаба) → берём «куртка парка».
