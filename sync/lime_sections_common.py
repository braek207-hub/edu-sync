...
_VK_PUB_MARKERS = ("vk ads", "mytarget", "vkads")
_PARAM_RE = re.compile(r"(?:^|[?&])(campaign_id|c)=([^&#]+)")
...
def app_campaign_channel(camp: str) -> str:
    """Канал app-кампании в номенклатуре PROCONTEXT."""
