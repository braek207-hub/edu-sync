...
# Порядок задаёт очередь обхода.
# Russever снят 19.09.2026 (решение Павла): модель дешёвого клика живёт на видео
# в мобильных приложениях, а словарь резал именно этот инвентарь. Площадки
# там режутся руками по накопленной статистике (отказы >60%), не автоматом.
