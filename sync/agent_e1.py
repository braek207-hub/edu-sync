...
# 2 дня, потому что крон GitHub опаздывает на 6–12 ч, и Э0 может пропаститься
# целиком (как 27.08.2026). Недельный план на три дня назад молча ломает экономику.
# 2 дня оставляет одну ночь на запоздалый прогон Э0 без потери корректности.
