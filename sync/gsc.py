...
REGIONS = {
    ...
    "gcc": {
        # ЭКСПЕРИМЕНТ (2026-07-18, по просьбе Павла): корневой limestore.com временно
        # ВЫКЛЮЧЕН из набора — смотрим блок по одним витринам Залива. Он обслуживает
        # тот же брендовый спрос (по ОАЭ 43 956 показов / 1 832 клика за 8 недель), но
        # клики с него ведут на глобальный сайт, а не в магазин Залива.
        # Вернуть = раскомментировать строку ниже и прогнать бэкфилл с gcc_gsc_from=2025-10-01.
        "sites": [
            ...
            # "https://limestore.com/",  # корневой — выключен на время эксперимента
        ],
        "countries": {
            "are": "ОАЭ",
