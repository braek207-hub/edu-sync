...
# Одно имя на ВСЕХ пишущих (прямое применение и сторож отката): они пишут в
# один кабинет и один журнал, и параллельный e1 во время отката — та же
# гонка, что два e1. Прежние независимые имена agent_e1/agent_e1_watchdog
# разрешали её молча.
RUN_LOCK_NAMES = ("agent_writer",)
