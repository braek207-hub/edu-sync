...
ALLOWED: Dict[str, str] = {
    ...
    # Полосы (задача 4) написаны раньше отбора, который их применяет:
    # lanes.select и врезка в agent_e1 — это задача 7. Обе записи снимаются
    # там же; если к бете они здесь, полосы посчитаны и выброшены.
    "lane_of": "потребитель — lanes.select, задача 7 плана беты",
