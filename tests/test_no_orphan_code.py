...
ALLOWED: Dict[str, str] = {
    ...
    # Лестница ступеней (задача 3 плана беты) написана раньше своих
    # потребителей: share_of зовёт writer/lanes.py (задача 4), step_of —
    # прогон такта (задача 26). Обе записи снимаются, когда потребители
    # появятся; если к бете они всё ещё здесь — лестница не подключена.
    "share_of": "потребитель — writer/lanes.py, задача 4 плана беты",
