...
ALLOWED: Dict[str, str] = {
    ...
    # Обратное решение того же человека на том же экране: «беру в работу».
    # Пара к reject и живёт по тем же правилам — вызов приходит из панели
    # Panda-BI, а не из прогона, и статически здесь не виден.
    "take_into_work": "потребитель — кнопка «в работу» на экране предложений (задача 27)",
