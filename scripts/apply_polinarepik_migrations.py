#!/usr/bin/env python3
"""Apply polinarepik schema migrations before sync (idempotent)."""
...
MIGRATIONS_DIR = ROOT / "migrations" / "polinarepik"
    ...
    with connect() as conn:
        with conn.cursor() as cur:
            ...
            cur.execute(
                ...
                WHERE table_schema = 'public' AND table_name LIKE 'polinarepik%%'
                ORDER BY table_name
                """
            )
